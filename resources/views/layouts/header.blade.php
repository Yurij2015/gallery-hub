            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="/" class="flex ml-2 md:mr-24">
                        ...
                        <span class="self-center text-xl font-semibold sm:text-xl whitespace-nowrap dark:text-white">GalleryHub</span>
                    </a>
                    <form action="#" method="GET" class="hidden lg:block lg:pl-3.5 search-form" >
