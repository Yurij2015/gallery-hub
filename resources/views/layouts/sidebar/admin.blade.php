                ...
                <ul class="pb-2 space-y-2">
                    <li>
                        <form action="#" method="GET" class="lg:hidden">
                            <label for="mobile-search" class="sr-only">{{ __('message.search') }}</label>
                            <div class="relative">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}"
                           class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::is('dashboard') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                            <svg
                                class="w-6 h-6 text-gray-500 transition duration-75 group-hove   dr:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
...
{{--                    </li>--}}
                    ...
                    <li>
                        <a href="{{ route('projects.all-reviews') }}"
                           class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::is('projects.all-reviews') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                            <svg
                                class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="ml-3" sidebar-toggle-item>{{ __('message.reviews') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('projects.archive') }}"
                           class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::is('projects.archive') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                            <svg
                                class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                            ...
                            <span class="ml-3" sidebar-toggle-item>{{ __('message.archive') }}</span>
                        </a>
                    </li>
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                  sidebar-toggle-item>Subscriptions</span>
                        ...
                        <ul id="dropdown-layouts"
                            class="py-2 space-y-2 {{ in_array(Route::currentRouteName(), ['packages.index', 'projects4.index', 'content.index', 'topics.index'])  ? '' : 'hidden' }}">
                            <li>
                                <a href="{{ route('packages.index') }}"
                                   ...
                                   {{ Route::currentRouteName() === 'packages.index' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Packages
                                </a>
                            </li>
                            <li>
                                <a href=""
                                   class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700
                                   {{ Route::currentRouteName() === 'subscriptions.index' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Subscriptions
                                </a>
                            </li>
                            <li>
                                <a href=""
                                   class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700
                                   {{ Route::currentRouteName() === 'payments.index' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Payments
                                </a>
                            </li>
                        </ul>
