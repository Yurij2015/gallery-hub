                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}"
                           class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::is('dashboard') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                            <svg
                    ...
                    <li>
                        <a href="{{ route('projects.index') }}"
                           class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::is('projects.index') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                            <svg
                                class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="ml-3" sidebar-toggle-item>{{ __('message.projects') }}</span>
                        </a>
                    </li>
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                  sidebar-toggle-item>Content manage</span>
                        ...
                        <ul id="dropdown-layouts"
                            class="py-2 space-y-2 {{ in_array(Route::currentRouteName(), ['sites.index', 'projects4.index', 'content.index', 'topics.index'])  ? '' : 'hidden' }}">
                            <li>
                                <a href="}"
                                   ...
                                   {{ Route::currentRouteName() === 'sites.index' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Sites
                                </a>
                            </li>
                            <li>
                                <a href=""
                                   class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700
                                   {{ Route::currentRouteName() === 'projects.index' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    Projects
                                </a>
                            </li>
                            <li>
                                <a href=""
                                   class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700
                                   {{ Route::currentRouteName() === 'topics.index' ? 'bg-gray-100 dark:bg-gray-700' : ''}}">
                                    Topics
                                </a>
                            </li>
                            <li>
                                <a href=""
                                   class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700
                                  {{ Route::currentRouteName() === 'content.index' ? 'bg-gray-100 dark:bg-gray-700' : '' }} ">
                                    Content
                                </a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        @php
                            $crud = false
                        @endphp
                        <ul id="dropdown-crud" class="space-y-2 py-2 {{ !$crud ? 'hidden' : '' }}">
                            <li>
                                <a href="/"
                                   class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::currentRouteName() === 'products' ? 'bg-gray-100 dark:bg-gray-700' : ''  }}">Products</a>
                            </li>
                            <li>
                                <a href="{{ "crud/users/"}}"
                                   class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::currentRouteName() === 'users' ? 'bg-gray-100 dark:bg-gray-700' : ''}} ">Users</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="/"
                           class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::currentRouteName() === 'settings' ? 'bg-gray-100 dark:bg-gray-700' : ''  }} ">
                            <svg
                                class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true">
                    ...
                    <li>
                        ...
                        @php
                            $plaground = true
                        @endphp
                        <ul id="dropdown-playground" class="space-y-2 py-2" {{ !$plaground ? 'hidden' : '' }}>
                            <li>
                                <a href="/"
                                   class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::currentRouteName() === 'stacked' ? 'bg-gray-100 dark:bg-gray-700' : ''  }} ">Stacked</a>
                            </li>
                            <li>
                                <a href="/"
                                   class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ Route::currentRouteName() === 'sidebar' ? 'bg-gray-100 dark:bg-gray-700' : ''  }}">Sidebar</a>
                            </li>
                        </ul>
                    </li>
                </ul>
