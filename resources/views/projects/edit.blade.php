    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">{{ __('message.editProject') }} - {{ $project->name }}</h1>
            </div>
        </div>
    </div>
                                ...
                                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <input
                                            ...
                                            aria-describedby="upload_directory_help" id="uploadDirectory" type="file"
                                            name="files[]" multiple
                                        >
                                    </div>
                                </div>
